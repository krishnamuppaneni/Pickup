...
namespace Pickup.Api.Controllers.V1.Identity
{
    ...
    public class ManageController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [ProducesResponseType(typeof(TwoFactorAuthenticationResponse), 200)]
        ...
        //    var model = new ShowRecoveryCodesResponse { RecoveryCodes = recoveryCodes };
        //    return View(model);
        //}
        ...
        /// <returns></returns>
        [HttpPost]
        [ProducesResponseType(typeof(ShowRecoveryCodesResponse), 200)]
        [ProducesResponseType(typeof(IEnumerable<string>), 400)]
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            var model = new ShowRecoveryCodesResponse { RecoveryCodes = recoveryCodes.ToArray() };
