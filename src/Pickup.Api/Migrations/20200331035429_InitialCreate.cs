    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PickupListId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    UpdatedDate = table.Column<DateTime>(nullable: false),
                    ListName = table.Column<string>(nullable: true),
                    DescriptionText = table.Column<string>(nullable: true),
                    PickupListStatus = table.Column<int>(nullable: false),
                    DeliveryLocationId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PickupLists", x => x.PickupListId);
                    table.ForeignKey(
                        name: "FK_PickupLists_Locations_DeliveryLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLocationId = table.Column<int>(nullable: true),
                    PickupListId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Deliveries_Locations_DeliveryLocationId",
                        column: x => x.DeliveryLocationId,
                        principalTable: "Locations",
                        principalColumn: "LocationId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_Locations_DriverLocationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deliveries_PickupLists_PickupListId",
                        column: x => x.PickupListId,
                        principalTable: "PickupLists",
                        principalColumn: "PickupListId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingNumb = table.Column<float>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_Users_DeliveryUserId",
                        column: x => x.DeliveryUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_Users_DriverUserId",
                        column: x => x.DriverUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_DriverLocationId",
                table: "Deliveries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_PickupListId",
                table: "Deliveries",
                column: "PickupListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PickupLists_DeliveryLocationId",
                table: "PickupLists",
                column: "DeliveryLocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DeliveryUserId",
                table: "Reviews",
                column: "DeliveryUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_DriverUserId",
                table: "Reviews",
                column: "DriverUserId");
