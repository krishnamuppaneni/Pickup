...
namespace Pickup.Api.Identity.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [ProducesResponseType(typeof(TwoFactorAuthenticationModel), 200)]
        ...
        [HttpGet]
        [ProducesResponseType(typeof(EnableAuthenticatorModel), 200)]
        [ProducesResponseType(typeof(IEnumerable<string>), 400)]
        ...
        [ProducesResponseType(typeof(IEnumerable<string>), 400)]
        [Route("enableAuthenticator")]
        public async Task<IActionResult> EnableAuthenticator([FromBody]EnableAuthenticatorModel model)
        {
            var user = await _userManager.FindByIdAsync(User.FindFirst("uid")?.Value);
            if (user == null)
                return BadRequest(new string[] { "Could not find user!" });
        ...
        /// <returns></returns>
        [HttpPost]
        [ProducesResponseType(typeof(ShowRecoveryCodesModel), 200)]
        [ProducesResponseType(typeof(IEnumerable<string>), 400)]
